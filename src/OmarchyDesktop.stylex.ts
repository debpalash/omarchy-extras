...
export const desktopStyles = stylex.create({
  ...
  topbar: {
    ...
    gridTemplateColumns: {
      ...
      '@media (max-width: 540px)': 'auto minmax(0, 1fr) auto',
    },
    alignItems: 'center',
    paddingInline: {
      default: '0.75rem',
  ...
  shellPopover: {
    ...
    maxHeight: {
      ...
      '@media (max-width: 720px)': 'calc(100% - 58px)',
    },
    overflowY: 'auto',
  ...
  windowsLayer: {
    ...
    inset: {
      default: '36px 0 0',
      '@media (max-width: 720px)': '44px 0 0',
    },
  },
  homeStackLayer: {
    overflowX: 'hidden',
  ...
  launcher: {
    ...
    width: {
      default: 'min(390px, calc(100% - 32px))',
      '@media (max-width: 720px)': 'calc(100% - 24px)',
    },
  ...
  launcherButton: {
    ...
    color: {
      default: '#f2ece3',
      ':hover': '#ff75ad',
      ':focus-visible': '#ff75ad',
    },
    backgroundColor: {
      default: 'transparent',
      ':hover': '#282229',
      ':focus-visible': '#282229',
    },
    borderWidth: 0,
    borderRadius: 0,
    font: 'inherit',
