...
The redesigned homepage uses Solid 2, StyleX, Vite 8, and a lazy Three.js WebGL scene. It deploys through Cloudflare Workers Static Assets. The official manual, news, teams, themes, security, and other routes are included locally from [`omacom/omarchy-site`](https://github.com/omacom/omarchy-site) at revision `31a5ecd`.
